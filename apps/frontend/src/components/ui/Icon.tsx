...
type IconName =
  | 'dashboard' | 'leads' | 'campaigns' | 'inbox' | 'autopilot' | 'settings' | 'team' | 'templates'
  | 'user' | 'users' | 'building' | 'mail' | 'phone' | 'globe' | 'linkedin'
  | 'chart-bar' | 'trending-up' | 'trending-down' | 'activity' | 'zap' | 'target' | 'send'
  | 'check' | 'x' | 'plus' | 'minus' | 'edit' | 'trash' | 'copy' | 'download' | 'upload' | 'export'
  | 'arrow-up' | 'arrow-down' | 'chevron-up' | 'chevron-down' | 'chevron-left' | 'chevron-right'
  | 'search' | 'filter' | 'sort' | 'columns' | 'eye' | 'eye-off'
  | 'bell' | 'star' | 'tag' | 'bookmark' | 'flag'
  | 'play' | 'pause' | 'refresh' | 'loader'
  | 'lock' | 'key' | 'shield'
  | 'calendar' | 'clock' | 'link' | 'external-link';
...
const ICONS: Record<IconName, React.ReactNode> = {
  ...
  building: (
    <>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 9h1m4 0h1M9 13h1m4 0h1M9 17h1m4 0h1" />
    </>
  ),
  mail: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
  ...
  filter: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3c2.755 0 5.455.232 8.083.678.533.09.917.556.917 1.096v1.044a2.25 2.25 0 01-.659 1.591L15.75 12.75v7.5a.75.75 0 01-.443.693l-3 1.5a.75.75 0 01-1.057-.693v-9l-4.591-5.381A2.25 2.25 0 016 5.818V4.774c0-.54.384-1.006.917-1.096A48.32 48.32 0 0112 3z" />
  ),
  sort: (
    <>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 6h18M3 12h12M3 18h6" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M19 10V20m0 0l-3-3m3 3l3-3" />
    </>
  ),
  columns: (
    <>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3h7a2 2 0 012 2v14a2 2 0 01-2 2h-7" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3H5a2 2 0 00-2 2v14a2 2 0 002 2h7" />
